...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .sidebar-nav li a:hover,.sidebar-nav li a.active{background:var(--forest);color:var(--white)}
        ...
        .av-green{background:var(--forest2)} .av-blue{background:#1a4f7a} .av-amber{background:#b8750a}
        ...
        .metric,.data-card,.form-section,.solde-card{background:var(--white);border:1px solid var(--border);border-radius:12px}
        ...
        .mi-green{background:var(--success-bg);color:var(--success)} .mi-amber{background:var(--warn-bg);color:var(--warn)} .mi-red{background:var(--danger-bg);color:var(--danger)} .mi-blue{background:var(--info-bg);color:var(--info)} .mi-forest{background:var(--mint);color:var(--forest)}
        ...
        .solde-card{padding:1.1rem 1.25rem;margin-bottom:1rem}
        ...
        .data-card{overflow:hidden;margin-bottom:1.5rem}
        ...
        .td-muted{color:var(--muted)} .td-mono{font-family:'DM Mono',monospace;font-size:.8rem}
        .statut{display:inline-flex;align-items:center;gap:5px;font-size:.7rem;font-weight:500;padding:4px 9px;border-radius:12px}
        .s-attente{background:var(--warn-bg);color:var(--warn)} .s-approuvee{background:var(--success-bg);color:var(--success)} .s-refusee{background:var(--danger-bg);color:var(--danger)} .s-annulee{background:#f1efe8;color:#7a8f80}
        .type-badge{display:inline-block;font-size:.68rem;font-weight:500;padding:3px 8px;border-radius:4px}
        .t-annuel{background:var(--mint);color:var(--forest)} .t-maladie{background:var(--info-bg);color:var(--info)} .t-special{background:#f0e8fb;color:#5a2d82} .t-sans-solde{background:#f1efe8;color:#7a8f80}
        .action-btns{display:flex;gap:5px;flex-wrap:wrap}
        .btn-sm{font-size:.72rem;font-weight:500;padding:5px 10px;border-radius:6px;border:1px solid transparent;cursor:pointer;display:inline-flex;align-items:center;gap:4px;font-family:'DM Sans',sans-serif;text-decoration:none}
        .btn-approve{background:var(--success-bg);color:var(--success);border-color:var(--success-br)} .btn-refuse{background:var(--danger-bg);color:var(--danger);border-color:var(--danger-br)} .btn-edit{background:var(--info-bg);color:var(--info);border-color:var(--info-br)} .btn-del,.btn-cancel,.btn-view{background:var(--cream);color:var(--muted);border-color:var(--border)}
        .btn-secondary{background:var(--white);color:var(--muted);border:1.5px solid var(--border);border-radius:8px;padding:9px 16px;font-size:.85rem;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;display:inline-flex;align-items:center;gap:6px;text-decoration:none}
        .btn-forest{background:var(--forest);color:var(--white);border:none;border-radius:8px;padding:9px 16px;font-size:.85rem;font-weight:500;cursor:pointer;font-family:'DM Sans',sans-serif;display:inline-flex;align-items:center;gap:6px;text-decoration:none}
        ...
        .hero-title{font-family:'Playfair Display',serif;font-size:2rem;color:var(--ink);line-height:1.1}
        .hero-text{color:var(--muted)}
        .pill{display:inline-flex;align-items:center;gap:7px;background:#fff;border:1px solid var(--border);border-radius:999px;padding:.5rem .8rem;font-size:.85rem;color:var(--ink)}
        .callout{border:1px solid #bcd6ef;background:var(--info-bg);border-radius:10px;padding:1rem;color:var(--info)}
        .grid-2{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1rem}
        .grid-3{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1rem}
        .grid-4{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem}
        .card{background:var(--white);border:1px solid var(--border);border-radius:12px;padding:1rem}
        .card h3{margin:0 0 .25rem;font-size:1rem}
        .card p{margin:0;color:var(--muted)}
        .tile{background:var(--white);border:1px solid var(--border);border-radius:12px;padding:1rem;display:grid;gap:.25rem}
        .tile strong{font-size:1.8rem;line-height:1}
        @media (max-width: 1120px){.grid-4{grid-template-columns:repeat(2,minmax(0,1fr))}}
        @media (max-width: 920px){.app-wrap{flex-direction:column}.sidebar{width:100%;height:auto;position:relative}.grid-2,.grid-3,.form-grid-2{grid-template-columns:1fr}.topbar{height:auto;padding:1rem;align-items:flex-start;flex-direction:column}.topbar-actions{margin-left:0}}
        @media (max-width: 600px){.content{padding:1rem}.grid-4{grid-template-columns:1fr}}
    </style>
</head>
<body>
